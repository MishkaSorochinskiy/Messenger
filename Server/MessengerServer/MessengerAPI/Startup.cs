...
namespace MessengerAPI
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env,UserManager<SecurityUser> um,RoleManager<IdentityRole>rm,SecurityContext sc,MessengerContext mc, IConfiguration conf)
        {
